...
public class SampleFlowInfo {
    ...
    @TypeInfo(MapFactory.class)
    public Map<String, String> map4= new HashMap<String, String>() {{
        put("p1", "p0");
        put("p7", "p5");
    }};;
    @TypeInfo(MapFactory.class)
    public Map<String, String> map5= new HashMap<String, String>() {{
        put("t8", "y8");
        put("t5", "t4");
    }};;
