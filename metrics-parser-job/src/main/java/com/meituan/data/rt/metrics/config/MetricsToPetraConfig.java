package com.meituan.data.rt.metrics.config;
...
public class MetricsToPetraConfig extends JobConfig {
    private static final Logger logger = LoggerFactory.getLogger(MetricsToPetraConfig.class);
    ...
    private Boolean outputPetraFormatedMetrics;

    public MetricsToPetraConfig() {
        InputStream inputStream = MetricsToPetraConfig.class.getClassLoader().getResourceAsStream("config.properties");
    ...
    public MetricsToPetraConfig(Configuration config) {
        this.initFromConfiguration(config);
    }
    ...
    public void initFromConfiguration(Configuration config) {
        ...
        if (config.containsKey("rt.metrics.output.petra")) {
            this.setOutputPetraFormatedMetrics(config.getBoolean("rt.metrics.output.petra", false));
        }
    ...
    public Configuration toConfiguration() {
        ...
        config.setString("rt.metrics.output.petra", this.getOutputPetraFormatedMetrics().toString());
        return config;
    }
    ...
    public Boolean getOutputPetraFormatedMetrics() {
        return this.outputPetraFormatedMetrics;
    }

    public void setOutputPetraFormatedMetrics(Boolean outputPetraFormatedMetrics) {
        this.outputPetraFormatedMetrics = outputPetraFormatedMetrics;
    }
}
