...
public class PetraMetric implements Serializable {
    private static final Logger logger = LoggerFactory.getLogger(PetraMetric.class);
    ...
    public PetraMetric(Map<String, List<Object>> kvs, Map<String, String> tags, Long ts) {
        this.kvs = kvs;
        this.tags = tags;
        this.ts = ts;
    }
